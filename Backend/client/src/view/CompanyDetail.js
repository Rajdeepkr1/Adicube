    ...
    return (props.trigger) ? (
        <div className="companyDetail">
            ...
            <div className="companny__det">
                ...
                <span className="bold">{props.user[0].firstname}</span>
                </div>
                <div className="companey">lastname : 
                <span className="bold">{props.user[0].lastname}</span>
                </div>
                <div className="companey">email : 
                <span className="bold">{props.user[0].email}</span>
                </div>
                <div className="companey">mobNumber : 
                <span className="bold">{props.user[0].number}</span>
                </div>
                <div className="companey">companyName : 
                <span className="bold">{props.user[0].companyName}</span>
                </div>
                <div className="companey">campaignBudget : 
                <span className="bold">{props.user[0].campaignBudget}</span>
                </div>
                {/* <div className="companey">Intagram followers : 
                <span className="bold">{props.user[0].companyName}</span>
                </div> */}
                <div className="companey">launchTiming : 
                <span className="bold">{props.user[0].launchTiming}</span>
                </div>
                <div className="companey">loginId : 
                <span className="bold">{props.user[0].loginId}</span>
                </div>
